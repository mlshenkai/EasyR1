# -*- coding: utf-8 -*-
# @Author: watcher
# @Created Time: 2025/2/12 15:06
# @File: ppo_trainer_orm
...
class PPOTrainerORM(ABC):
    ...
    def fit(
        ...
        start_episode = (
            consumed_samples // args.rollout_batch_size // num_rollouts_per_episodes
        )
                ...
                for i, experience in enumerate(
                    ...
                    if i == 0:
                        output = self.tokenizer.batch_decode(
                            experience.sequences[0].unsqueeze(0),
    ...
    def training_step_actor(self, experience: Experience) -> Dict[str, float]:
        ...
        if self.ema_model:
            self.strategy.moving_average(
                self.actor, self.ema_model, self.ema_beta, "cpu"
            )
