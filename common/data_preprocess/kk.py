...
def make_prefix(dp, template_type):
    ...
    if template_type == "base":
        ...
        prefix = """<|im_start|>system\nYou are a helpful assistant. The assistant first thinks about the reasoning process in the mind and then provides the user with the answer.final answer within \\boxed{}. The reasoning process and answer are enclosed within <think> </think> and<answer> </answer> tags, respectively, i.e., <think> reasoning process here </think><answer> answer here </answer>.  Now the user asks you to solve a logical reasoning problem. After thinking, when you finally reach a conclusion, clearly state the identity of each character within <answer> </answer> tags. i.e., <answer> (1) Zoey is a knight\n(2) ... </answer>.\n<|im_end|>\n<|im_start|>user\n{quiz}\n<|im_end|>\n<|im_start|>assistant\n<think>"""
    return prefix
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_dir", default="/code-online/code/EasyR1/data/kk/instruct/5ppl"
    )
    parser.add_argument("--hdfs_dir", default=None)
    parser.add_argument(
        "--data_path",
        default="/code-online/code/EasyR1/data/knights-and-knaves/train/people5_num1000.jsonl",
    )
    ...
    raw_dataset = Dataset.from_generator(
        gen_from_jsonl, gen_kwargs={"path": args.data_path}
    )
