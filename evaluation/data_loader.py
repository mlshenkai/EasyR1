...
def load_data(data_name, split, data_dir="./data"):
    ...
    if os.path.exists(data_file):
        ...
        if data_name in ["math", "hendrycks/competition_math", "competition_math"]:
        ...
        elif data_name == "flatlander1024/numinamath_verifiable_cleaned_wo_geo_mc":
            dataset = load_dataset("flatlander1024/numinamath_verifiable_cleaned_wo_geo_mc", split=split)
        else:
